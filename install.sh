#!/usr/bin/env sh
# Universal installer for setup-scripts. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/setup-scripts.git"
...
echo "Done. Run: setup-scripts --help"
